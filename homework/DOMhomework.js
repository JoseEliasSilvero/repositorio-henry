...
function buildToDos(toDos) {
 ...
 // let array = toDos.map(function(todo, index){  //map metodo de array,sirve para recorrer un array, una funcion que minimo necesita 2 argumentos;map y filter siempre retorna un nuevo array
   // return buildToDo(todo, index)   //se le envia la fn buildTodo los parametros q estaba esperando, 
  //});  
...
function addToDo() {
  ...
  if(input.value !== ''){
    ...
    input.value = '';   //3
    displayToDos();   //4 es la encargada de mostrar en pantalla
  }
}
